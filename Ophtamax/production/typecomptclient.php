...
<html lang="fr">
  ...
  <div class="container body">
			...
			<div class="right_col" role="main">
				<div class="">
					<div class="page-title">
						...
						<h3><img src="images/plusv2.png"> Nouveau Type Compte Client</h3>
						</div>
					...
					<div class="row">
						<div class="col-md-12 col-sm-12 ">
							<div class="x_panel">
								<div class="x_title">
									<h2>Add New Account Type<small></small></h2>
								...
								<div class="x_content">
									<br />
									<form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" action="requires/save_type.php" method="post">
						...
						<div class="col-md-12 col-sm-12 ">
							<div class="x_panel">
								<div class="x_title">
									<h2>Liste des types de compte<small></small></h2>
									<ul class="nav navbar-right panel_toolbox">
										<li><a class="collapse-link"><i class="fa fa-chevron-up"></i></a>
										</li>
										<li class="dropdown">
    ...
    $REQ_LISTE_TYPEC= $pdo -> prepare("SELECT * FROM typecompte ORDER BY code ASC");
   /* $PARAM = array($login);*/
    $REQ_LISTE_TYPEC  -> execute();
       ?>
              ...
              <?php 
				 while ($TCOMPTE = $REQ_LISTE_TYPEC->fetch()) { 
					...
					?>
                            ...
                            <tr>
                              <th scope="row"><?php echo($TCOMPTE['code']) ?></th>
							  
            
							  <td><?php echo($TCOMPTE['libelle']) ?></td>
							  <td><a style="bacbround: red;" onclick="return confirm('Etes-vous sûre ?');" href="####?code=<?php echo($TCOMPTE['id']) ?>"><span class="btn btn-danger" align="center">Supprimer</span></a></td>
