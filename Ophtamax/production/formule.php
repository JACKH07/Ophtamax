...
<html lang="fr">
  ...
  <div class="container body">
			...
			<div class="right_col" role="main">
				<div class="">
					<div class="page-title">
						...
						<h3><img src="images/plusv2.png"> Nouvelle Fromule</h3>
						</div>
					...
					<div class="row">
						<div class="col-md-12 col-sm-12 ">
							<div class="x_panel">
								<div class="x_title">
									<h2>Add New Formule &emsp; &emsp;&emsp; &emsp;      

									<small style="color:#32CD32; align: center;"> 
										
										<?php if (isset($_SESSION['mafrmle']) && !empty($_SESSION['mafrmle'])) {
									   echo $_SESSION['mafrmle'];
									   unset($_SESSION['mafrmle']);  
									   } ?>
								   </small>
								...
								<div class="x_content">
									<br />
									<form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" action="requires/save_formule.php" method="post">
										...
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<input type="text" id="last-name" name="libelle" required="required" class="form-control">
											</div>
										</div>
						...
						<div class="col-md-12 col-sm-12 ">
							<div class="x_panel">
								<div class="x_title">
									<h2>Liste des formules<small></small></h2>
									<ul class="nav navbar-right panel_toolbox">
										<li><a class="collapse-link"><i class="fa fa-chevron-up"></i></a>
										</li>
										<li class="dropdown">
    ...
    $REQ_LISTE_FORMULE= $pdo -> prepare("SELECT * FROM formule_abmt ORDER BY id ASC");
   /* $PARAM = array($login);*/
    $REQ_LISTE_FORMULE  -> execute();
       ?>
              ...
              <?php 
				 while ($FORMULE = $REQ_LISTE_FORMULE->fetch()) { 
					...
					?>
                            ...
                            <tr>
                              <th scope="row"><?php echo($FORMULE['id']) ?></th>
							  <td><?php echo($FORMULE['code']) ?></td>
							  <td><?php echo($FORMULE['libelle']) ?></td>
							  
							 
							  <!-- <td><a style="bacbround: red;" href="####?code=<?php echo($FORMULE['id']) ?>"><span class="btn btn-success" align="center">Editer</span></a></td> -->
                              <td><a style="bacbround: red;" onclick="return confirm('Etes-vous sûre ?');" href="requires/del_formule.php?code=<?php echo($FORMULE['id']) ?>"><span class="btn btn-danger" align="center">Supprimer</span></a></td>
