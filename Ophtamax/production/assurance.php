...
<head>
  ...
  <body class="nav-md">
			...
			<div class="right_col" role="main">
				<div class="">
					<div class="page-title">
						...
						<h3><img src="images/plusv2.png"> Nouvelle Assurance</h3>
						</div>
					...
					<div class="row">
						<div class="col-md-12 col-sm-12 ">
							<div class="x_panel">
								<div class="x_title">
									<h2>Add New Health Insurance &emsp; &emsp;&emsp; &emsp;      

									<small style="color:#32CD32; align: center;"> 
										
										<?php if (isset($_SESSION['maSce']) && !empty($_SESSION['maSce'])) {
									   echo $_SESSION['maSce'];
									   unset($_SESSION['maSce']);  
									   } ?>
								   </small>
								...
								<div class="x_content">
									<br />
									<form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" action="requires/save_service.php" method="post">
						...
						<div class="col-md-12 col-sm-12 ">
							<div class="x_panel">
								<div class="x_title">
									<h2>Liste des assurances<small></small></h2>
									<ul class="nav navbar-right panel_toolbox">
										<li><a class="collapse-link"><i class="fa fa-chevron-up"></i></a>
										</li>
										<li class="dropdown">
    ...
    $REQ_LISTE_ASSURANCE= $pdo -> prepare("SELECT * FROM assurance ORDER BY idass ASC");
   /* $PARAM = array($login);*/
    $REQ_LISTE_ASSURANCE  -> execute();
       ?>
              ...
              <?php 
				 while ($ASS = $REQ_LISTE_ASSURANCE->fetch()) { 
					...
					?>
                            ...
                            <tr>
                              <th scope="row"><?php echo($ASS['idass']) ?></th>
							  
            
							  <td><?php echo($ASS['libelleass']) ?></td>
							  <!--<td><a style="bacbround: red;" onclick="return confirm('Etes-vous sûre ?');" href="del_service.php?code=<?php echo($SCE['id']) ?>"><span class="btn btn-danger" align="center">Supprimer</span></a></td>-->
