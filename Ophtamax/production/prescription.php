  ...
  <body class="nav-md">
			...
			<div class="right_col" role="main">
				<div class="">
					<div class="page-title">
						...
						<h3><img src="images/plusv2.png"> Nouvelle Prescription</h3>
						</div>
					...
					<div class="row">
						<div class="col-md-12 col-sm-12 ">
							<div class="x_panel">
								...
								<div class="x_content">
									<br />
									<form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" action="requires/save_numero.php" method="post">

										<div class="item form-group">
											<label class="col-form-label col-md-3 col-sm-3 label-align" for="first-name">Numéro <span class="required">*</span>
											</label>
											<div class="col-md-6 col-sm-6 ">
												<input type="text" id="first-name" required="required" class="form-control " name="numero">
											</div>
										</div>
   ...
   /* $PARAM = array($login);*/
    ...
    ?>
										...
										<div class="item form-group">
											<label class="col-form-label col-md-3 col-sm-3 label-align" for="last-name">Type Numéro <span class="required">*</span></label>
											<div class="col-md-6 col-sm-6 ">
												<select class="form-control" name="tcompte">
												<option>---</option>
													
													<?php  while ($TYP = $REQ_LISTE_TYPE -> fetch()) { ?>
                           
						   								<option value="<?php echo($TYP['code']) ?>"><?php echo($TYP['code']) ?></option>
						...
						<div class="col-md-12 col-sm-12 ">
							<div class="x_panel">
								<div class="x_title">
									<h2>Liste des numéros<small></small></h2>
									<ul class="nav navbar-right panel_toolbox">
										<li><a class="collapse-link"><i class="fa fa-chevron-up"></i></a>
										</li>
										<li class="dropdown">
    ...
    require_once("requires/cnx.php");
    $REQ_LISTE_NUMERO= $pdo -> prepare("SELECT * FROM numero ORDER BY numero ASC");
   /* $PARAM = array($login);*/
    $REQ_LISTE_NUMERO  -> execute();
       ?>
              ...
              <?php 
				 while ($NUM = $REQ_LISTE_NUMERO->fetch()) { 
					...
					?>
                            ...
                            <tr>
                              <th scope="row"><?php echo($NUM['numero']) ?></th>
							  <td><?php echo($NUM['typenum']) ?></td>
							  <td><?php echo($NUM['operateur']) ?></td>
							  
							 
							  <!-- <td><a style="bacbround: red;" href="####?code=<?php echo($NUM['id']) ?>"><span class="btn btn-success" align="center">Editer</span></a></td> -->
                              <td><a style="bacbround: red;" onclick="return confirm('Etes-vous sûre ?');" href="requires/del_numero.php?code=<?php echo($NUM['id']) ?>"><span class="btn btn-danger" align="center">Supprimer</span></a></td>
