...
<html lang="fr">
  ...
  <div class="container body">
			...
			<div class="right_col" role="main">
				<div class="">
					<div class="page-title">
						...
						<h3><img src="images/plusv2.png"> Nouvelle Business Unit</h3>
						</div>
					...
					<div class="row">
						<div class="col-md-12 col-sm-12 ">
							<div class="x_panel">
								...
								<div class="x_content">
									<br />
									<form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" action="requires/save_bu.php" method="post">
    ...
    $REQ_LISTE_SCE = $pdo -> prepare("SELECT * FROM services ORDER BY code ASC");
   /* $PARAM = array($login);*/
    $REQ_LISTE_SCE  -> execute();
       ?>
										...
										<div class="item form-group">
											<label class="col-form-label col-md-3 col-sm-3 label-align" for="last-name">Services <span class="required">*</span></label>
											<div class="col-md-6 col-sm-6 " name="code_sce">
												<select class="form-control" name="code_sce">
													<option>---</option>
						...
						<div class="col-md-12 col-sm-12 ">
							<div class="x_panel">
								<div class="x_title">
									<h2>Liste des BU<small></small></h2>
									<ul class="nav navbar-right panel_toolbox">
										<li><a class="collapse-link"><i class="fa fa-chevron-up"></i></a>
										</li>
										<li class="dropdown">
              ...
              <?php 
				 while ($BU = $REQ_LISTE_BU->fetch()) { 
					...
					?>
                            ...
                            <tr>
                              <th scope="row"><?php echo($BU['code']) ?></th>
							  
            
							  <td><?php echo($BU['code_sce']) ?></td>
