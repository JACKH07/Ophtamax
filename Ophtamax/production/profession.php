...
<head>
  ...
  <body class="nav-md">
			...
			<div class="right_col" role="main">
				<div class="">
					<div class="page-title">
						...
						<h3><img src="images/plusv2.png"> Nouvelle Profession</h3>
						</div>
					...
					<div class="row">
						<div class="col-md-12 col-sm-12 ">
							<div class="x_panel">
								<div class="x_title">
									<h2>Add New Function<small></small></h2>
								...
								<div class="x_content">
									<br />
									<form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" action="requires/save_fonction.php" method="post">
						...
						<div class="col-md-12 col-sm-12 ">
							<div class="x_panel">
								<div class="x_title">
									<h2>Liste des professions<small></small></h2>
									<ul class="nav navbar-right panel_toolbox">
										<li><a class="collapse-link"><i class="fa fa-chevron-up"></i></a>
										</li>
										<li class="dropdown">
    ...
    $REQ_LISTE_FONCTION= $pdo -> prepare("SELECT * FROM fonction ORDER BY code ASC");
   /* $PARAM = array($login);*/
    $REQ_LISTE_FONCTION  -> execute();
       ?>
              ...
              <?php 
				 while ($FONCTION = $REQ_LISTE_FONCTION->fetch()) { 
					...
					?>
                            ...
                            <tr>
                              <th scope="row"><?php echo($FONCTION['code']) ?></th>
							  
							  <td><?php echo($FONCTION['libelle']) ?></td>
							  
							 
							  <!-- <td><a style="bacbround: red;" href="####?code=<?php echo($FONCTION['id']) ?>"><span class="btn btn-success" align="center">Editer</span></a></td>
                              <td><a style="bacbround: red;" onclick="return confirm('Etes-vous sûre ?');" href="####?code=<?php echo($FONCTION['id']) ?>"><span class="btn btn-danger" align="center">Supprimer</span></a></td> -->
