			...
			<div class="right_col" role="main">
				<div class="">
					<div class="page-title">
						...
						<h3><img src="images/plusv2.png"> Nouveau Rôle</h3>
						</div>
					...
					<div class="row">
						<div class="col-md-12 col-sm-12 ">
							<div class="x_panel">
								<div class="x_title">
									<h2>Add New Role&emsp; &emsp;&emsp; &emsp;      

											<small style="color:#32CD32; align: center;"> 

												<?php if (isset($_SESSION['maRole']) && !empty($_SESSION['maRole'])) {
														echo $_SESSION['maRole'];
														unset($_SESSION['maRole']);  
												} ?>
											</small>
									</h2>
								...
								<div class="x_content">
									<br />
									<form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" action="requires/save_role.php" method="post">
						...
						<div class="col-md-12 col-sm-12 ">
							<div class="x_panel">
								<div class="x_title">
									<h2>Liste des rôles<small></small></h2>
									<ul class="nav navbar-right panel_toolbox">
										<li><a class="collapse-link"><i class="fa fa-chevron-up"></i></a>
										</li>
										<li class="dropdown">
   ...
   /* $PARAM = array($login);*/
    $REQ_LISTE_ROLES  -> execute();
       ?>
              ...
              <?php 
				 while ($ROLE = $REQ_LISTE_ROLES->fetch()) { 
					...
					?>
                            ...
                            <tr>
                              <th scope="row"><?php echo($ROLE['code']) ?></th>
