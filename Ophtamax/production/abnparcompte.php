			...
			<div class="right_col" role="main">
				<div class="">
					<div class="page-title">
						...
						<h3><img src="images/group1.png"> &emsp;  Liste des abonnés par compte <!-- <img src="images/bar-chartv1.png">--></h3> 
						</div>
						...
						<div class="col-md-12 col-sm-12 ">
							<div class="x_panel">
                              ...
                              /* $PARAM = array($login);*/
									...
									?>
                            				<tr>
                                            <td><h2 style="padding-left: 5px;">Liste des comptes: </h2><td>
												<!-- 
									...
									<button style="border:0px; background:#FFFFFF;" type="submit" name="pdf" id="exportpdf"><img src="images/pdf11.png"> </button>&emsp;
									 ...
									 <div class="table-responsive" style="height: 400px; overflow: auto;">
											...
											<tbody>
												...
												require_once("requires/cnx.php");
												$REQ_LISTE_ABONNE_COMPTE = $pdo -> prepare("SELECT * FROM attribution_sim WHERE cclient=? ORDER BY npabn ASC ");
												$PARAM = array($compteC);
												$REQ_LISTE_ABONNE_COMPTE -> execute($PARAM);

														while ($ABN = $REQ_LISTE_ABONNE_COMPTE->fetch()) {
												?>
														<tr>
