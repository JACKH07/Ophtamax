			...
			<div class="right_col" role="main">
				<div class="">
					<div class="page-title">
						...
						<h3><img src="images/group1.png"> &emsp;  Liste des abonnés par service <!-- <img src="images/bar-chartv1.png">--></h3> 
						</div>
						...
						<div class="col-md-12 col-sm-12 ">
							<div class="x_panel">
								...
								// 	$REQ_LISTE_SCE  -> execute();
                                    ...
                                    $REQ_LISTE_SERVICES = $pdo -> prepare("SELECT * FROM services ORDER BY id ASC");
                              /* $PARAM = array($login);*/
                                     $REQ_LISTE_SERVICES  -> execute();
									?>
                            				<tr>
                                            <td><h2 style="padding-left: 5px;">Liste des services: </h2><td>
												<!-- 
												...
												<select class="form-control" name="services" required="required">
                                                            ...
                                                            <?php  while ($SCE = $REQ_LISTE_SERVICES -> fetch()) { ?>
								...
								<div class="x_content"> 
									 ...
									 <div class="x_title">
									<h2>Liste des abonnés<small></small></h2>
									...
									<button style="border:0px; background:#FFFFFF;" type="submit" name="pdf" id="exportpdf"><img src="images/pdf11.png"> </button>&emsp;
									 ...
									 <div class="table-responsive" style="height: 400px; overflow: auto;">
											...
											<tbody>
												...
												require_once("requires/cnx.php");
												$REQ_LISTE_ABONNE_SERVICE = $pdo -> prepare("SELECT * FROM attribution_sim WHERE sceabn=? ORDER BY npabn ASC ");
												$PARAM = array($Service);
												$REQ_LISTE_ABONNE_SERVICE -> execute($PARAM);

														while ($ABN = $REQ_LISTE_ABONNE_SERVICE->fetch()) {
												?>
														<tr>
														<th scope="row"><?php echo($ABN['cclient']) ?></th>
														<td><?php echo($ABN['buabn']) ?></td>
														<td><?php echo($ABN['npabn']) ?></td>
														<td><?php echo($ABN['numabn']) ?></td>
														<td><?php echo($ABN['formuleabn']) ?></td>
														<!-- <td><?php echo($ABN['datelimitpaie']) ?></td> -->
