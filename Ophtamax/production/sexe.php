			...
			<div class="right_col" role="main">
				<div class="">
					<div class="page-title">
						...
						<h3><img src="images/plusv2.png"> Nouveau Genre</h3>
						</div>
					...
					<div class="row">
						<div class="col-md-12 col-sm-12 ">
							<div class="x_panel">
								<div class="x_title">
									<h2>Add New Gender<small></small></h2>
								...
								<div class="x_content">
									<br />
									<form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" action="requires/save_sexe.php" method="post">
						...
						<div class="col-md-12 col-sm-12 ">
							<div class="x_panel">
								<div class="x_title">
									<h2>Liste des genres<small></small></h2>
									<ul class="nav navbar-right panel_toolbox">
										<li><a class="collapse-link"><i class="fa fa-chevron-up"></i></a>
										</li>
										<li class="dropdown">
   ...
   /* $PARAM = array($login);*/
    $REQ_LISTE_GENRE  -> execute();
       ?>
              ...
              <?php 
				 while ($GENRE = $REQ_LISTE_GENRE->fetch()) { 
					...
					?>
                            ...
                            <tr>
                              <th scope="row"><?php echo($GENRE['code']) ?></th>
